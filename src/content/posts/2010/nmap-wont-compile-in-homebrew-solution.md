...
description: "Blog post about nmap won't compile in homebrew solution"
...
![](/uploads/2010/12/nmap_homebrew.png "nmap_homebrew")I recently moved my Mac Pro dev box to homebrew from macports.  Doing the mysql move (the lazy way -- moving the data directory) was easy enough but doing a massive `brew install` of a bunch of packages didn't work when I got to [nmap](http://nmap.org/) (the network port scanner).
