...
description: "_The opinions of this blog, but especially this post are mine and not my employers'._"
...
I've done the DC government contracting circuit and I've concluded that I've seen enough.  It doesn't really matter what company you work for, it's the same project with the same people and the same problems.  However, a few years ago I found a small life raft.  It's a non-profit R&D shop and it's the best big tech company I've found in DC.  It's not perfect but at the core of it is the non-profit bit.  It's **not** [Beltway Bandit](http://en.wikipedia.org/wiki/Beltway_bandits) time.
...
![dc_old_mainframes](/uploads/2014/05/dc_old_mainframes.jpg)
...
1. Ok, there's 50 states.
1. It looks like you can drill down into about 4-5 counties per state.
1. That means we have 300-ish maps we need to port.
1. Kevin, you take 80 maps.  Stacey, you take 120 maps ...

I'm sitting there looking at the URL and what's actually happening is this:
<code>http://legacyapp/map.cfm?state=1&county=20</code>
...
![dc_arlington](/uploads/2014/05/dc_arlington.png)
...
- If you have a clearance, you can <strong>really, really, really</strong> get a job anytime you want.
...
![dc_traffic](/uploads/2014/05/dc_traffic.jpg)
...
Infinite [Sharepoint Administrator](http://www.washingtonpost.com/jobs/JobSearchServlet?location=&keyword=Sharepoint&localRadio=0) jobs.  What.  How can "Sharepoint Architect" even be a job title.  Bad Government work is so hard to prune and avoid.  There are really weird cobwebs out there.  When you live here, you are competing with these salaries.  They keep home prices up.
...
![mt_hood](/uploads/2014/05/mt_hood.jpg)

I gave it 14 years but I'm moving to Portland.  Hope springs eternal in the human breast.  I understand that nothing is perfect.  Things like the [Calagator event calendar](http://calagator.org/) look absolutely amazing to me.  Look at this schedule!
...
Yes, there are similar events in DC (Bruce is probably talking here).  There's a lot of cool stuff happening in an Open Government mailing list called [Sunlight Labs](https://groups.google.com/forum/#!forum/sunlightlabs).
I wrote [a blog post](/posts/rails-dev-shops-in-washington-dc/) attempting to enumerate awesome shops in DC (I picked Rails as a starting point).  It wasn't as long as I had hoped.  [Peter Corbett](http://istrategylabs.com/team/peter-corbett/) is an awesome guy.  I'd seriously suggest networking with him if you get the chance.
