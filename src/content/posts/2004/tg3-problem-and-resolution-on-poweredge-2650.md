...
description: "I had a flaky network problem where high loads fast downloads from tux.org or sun.com would cause a hang or complete drop of all network connections"
