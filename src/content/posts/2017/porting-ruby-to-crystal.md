...
The concrete example I'm going to use is [my previous blog post](/posts/ruby-slop-example/)
...
it _does not_ demonstrate is long term maintenance problems that happen after it's written once for a blog
post.
...
```
+----------------------------------------------+   +----------------------------------------------+
|      Ruby Program I Want To Share            |   |      Binary Program I Want To Share          |
+----------------------------------------------+   +----------------------------------------------+
|homebrew or rbenv/rvm/chruby                  |   |homebrew                                      |
|ruby                                          |   |                                              |
|bundler                                       |   |                                              |
|git                                           |   |                                              |
+----------------------------------------------+   +----------------------------------------------+
...
+----------------------------------------------+   +----------------------------------------------+
|#!/usr/bin/env ruby                           |   |<binary build / release on github>            |
|puts "Hi!"                                    |   |                                              |
|                                              |   |homebrew tap squarism/tap                     |
|chmod u+x ./utility.rb                        |   |brew install utility                          |
|mv utility.rb utility ~/bin                   |   |                                              |
|path+=~/bin  # for zsh anyway                 |   |$ utility                                     |
|                                              |   |Hi!                                           |
|$ utility                                     |   |                                              |
|Hi!                                           |   |                                              |
+----------------------------------------------+   +----------------------------------------------+
...
+----------------------------------------------+   +----------------------------------------------+
|           Basically I'm asking ...           |   |           Basically I'm asking ...           |
+----------------------------------------------+   +----------------------------------------------+
|  "Please install a dev environment."         |   |  "Please use a package manager."             |
+----------------------------------------------+   +----------------------------------------------+
```
...
So, what to do? _I just want a command in my path_. Do I have to switch languages?
...
But in this exercise, I really did _port_. It's a simple program, sure but I _really did_ copy
