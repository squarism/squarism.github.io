...
<p id="footnote-1"><sub>[1] Nothing is normal</sub><p id="footnote-2"><sub>[2] I prefer better/worse over good/bad.  In this case it'd be smaller and larger
which is awkward in this case.  The only rock we have to stand on in C.S. is metrics, everything else is opinion (like
this very statement!).</sub>