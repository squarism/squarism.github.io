...
draft: false
tags: ["blog"]
excerpt: "Treat big upgrades as an experiment."
---
...
- This same workflow can work to update django or flask or something huge and _you have a list to work on_
...
Dynamic languages need a runtime or [really a development environment](/posts/porting-ruby-to-crystal/) (unfortunately).
