...
preference. There probably _is_ a wrong way to test your project if you have
...
```text
 △   ┌────────────────────────────┐  ┌ ─ ─ ─ ─ ─ ─ ─ ─ ┐
 │   │  TEST DRIVEN DEVELOPMENT   │ ◀ "Testing leads me
 │   │           (TDD)            │  │to the design of │
 │   └────────────────────────────┘   the software"
 │                                   └ ─ ─ ─ ─ ─ ─ ─ ─ ┘

 C
 R   ┌────────────────────────────┐  ┌ ─ ─ ─ ─ ─ ─ ─ ─ ┐
 E   │   TEST FIRST DEVELOPMENT   │ ◀ "I usually start
 D   └────────────────────────────┘  │with a test just │
 E                                    to help me think"
 N                                   └ ─ ─ ─ ─ ─ ─ ─ ─ ┘
 C
 E
     ┌────────────────────────────┐  ┌ ─ ─ ─ ─ ─ ─ ─ ─ ┐
 /   │EXTENSIVE PRACTICAL TESTING │ ◀ "We wrote a lot
     └────────────────────────────┘  │of tests in      │
 D                                    different ways,
 O                                   │it's not a big   │
 G                                    deal"
 ...
 /   ┌────────────────────────────┐  ┌ ─ ─ ─ ─ ─ ─ ─ ─ ┐
     │ EXECUTABLE PARTIAL TESTING │ ◀ "I wrote some
 F   └────────────────────────────┘  │unit tests"      │
 A                                    ─ ─ ─ ─ ─ ─ ─ ─ ─
 I
 T   ┌────────────────────────────┐  ┌ ─ ─ ─ ─ ─ ─ ─ ─ ┐
 H   │       MANUAL TESTING       │ ◀ "I ran it and it
     └────────────────────────────┘  │seems to work"   │
 │                                    ─ ─ ─ ─ ─ ─ ─ ─ ─
 │
 │   ┌────────────────────────────┐  ┌ ─ ─ ─ ─ ─ ─ ─ ─ ┐
 │   │     NO TESTING AT ALL      │ ◀ "I wrote some
 ◇   │     (no one does this)     │  │code but never   │
     └────────────────────────────┘   ran it"
                                     └ ─ ─ ─ ─ ─ ─ ─ ─ ┘
```
...
happen. It's also _not the best way to test_ just because it's at the end of
this list.
...
> plus sign on there and call it addition?" <br />
> You: "Sure!"
...
opportunity to use it as an approach. It's not required to go all the way to TDD because testing is a gradient spectrum.
