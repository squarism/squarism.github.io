...
<p>So you walk across the street and try to find Barry.  He's pulling out of the driveway and he says "hop in!".
...
<p>And here's some code to step through the XML doc and print what's going on.</p>
<pre lang="ruby" line="1">
require 'rexml/document'
include REXML</p>
<p>xmlfile = File.new("yak.xml")
xmldoc = Document.new(xmlfile)</p>
<p># Now get the root element
root = xmldoc.root</p>
<p># hack
module REXML
...
<p>    recurse(childElement)
  end</p>
<p>end  </p>
<p>recurse(xmldoc)
</pre></p>
<p>When we run it, we get this:
<code>
[Get Coffee]
I don't have my keys...
[Find Keys]
